      ...
      <div className="content-container">
        <div className="title-container">
          ...
          <p className="description">
            Developer Students Club of NSEC brings to you Winter of Code which
            is a month-long extravaganza of Open Source contribution, bringing
        ...
        <div className="card-containerSOM">
          <div className="cardSOM">
            ...
            <p className="card-description">
              ...
              students amalgamate with their organisations prior to the start
              of coding and learn more about their organisation’s community.
              Students then have one month to code and meet the deadlines
              agreed upon with their mentors. On successful completion of the
              program students will be rewarded with some cool schwags.
            </p>
          </div>
          ...
          <div className="cardSOM">
            ...
            <p className="card-description">
              ...
              and suggest possible improvements to the code. They also
              determine if a student has successfully completed the Winter of
              code 2020 project. Students are then notified of the pass/fail
              status and schwags are delivered accordingly.
            </p>
          </div>
        </div>
      </div>
