      ...
      <div>
        ...
        <ul className="coc_list">
          ...
          <li>
            ...
            <a href="mailto: dscnsecorg@gmail.com"> dscnsecorg@gmail.com </a>
            <span>
              {" "}
          ...
          <li>
            ...
            <ul className="emails">
              <li>
                Souvik Pal:{" "}
                <a href="mailto:kolkatasouvik1@gmail.com">
                  kolkatasouvik1@gmail.com
                </a>
              </li>
              <li>
                Subhajit Hait:{" "}
                <a href="mailto:hsubhajit454@gmail.com">
                  hsubhajit454@gmail.com
                </a>
              </li>
              <li>
                Nikhil Mishra:{" "}
                <a href="mailto:mnik7044@gmail.com">mnik7044@gmail.com</a>
              </li>
              <li>
                Debojit Saha:{" "}
                <a href="mailto:saha05debojit@gmail.com">
                  saha05debojit@gmail.com
                </a>
              </li>
            </ul>
          </li>
